"""Logging utilities for the AIO Tests MCP server.
...
def setup_logging(
    ...
    """
    Configure logging with level-based stream routing.
    ...
    loggers = ["aio-tests-mcp", "mcp.server", "mcp.server.lowlevel.server"]
    ...
    return logging.getLogger("aio-tests-mcp")
...
def log_config_param(
    ...
    Args:
        ...
        service: The service name (e.g. "AIO Tests")
