...
from .exceptions import AIOAuthenticationError
from .utils.logging import log_config_param, mask_sensitive
from .utils.ssl import configure_ssl_verification

logger = logging.getLogger("aio-tests-mcp.client")
...
class AIOClient:
    ...
    def request(
        ...
        *,
        ...
        Raises:
            AIOAuthenticationError: If the API rejects the credentials.
    ...
    def _raise_for_response(method: str, path: str, response: Response) -> None:
        ...
        Raises:
            AIOAuthenticationError: For 401 and 403 responses.
